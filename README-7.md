...
1. Clone the repository and move into the project folder:
   ...
   cd logistics-supply-chain-operations-mis
   ```
...
3. Launch the dashboard:
   ...
   ```
4. The dashboard opens in your browser, reading directly from the CSV files in `data/`.

To regenerate the dataset with fresh random values, run `python src/generate_data.py` from the project root (this overwrites the files in `data/`).
